...
function SetupDocs() {
    ...
    const handleSetupDocs = async (e) => {
        ...
        try {
          ...
          const setupDocs = await axios.post("http://localhost:5500/api/setupCourtesy", { formData });
		  console.log(setupDocs)
		  const formDataImg = new FormData();
		  formDataImg.append("SignatureImg", formData.signature_img);
		  await axios.put("http://localhost:5500/api/uploadSignatureImg", formDataImg, {
			  headers: {
				"Content-Type": "multipart/form-data",
				authtoken: user.user.token, 
			  },
			});
          navigate("/admin/approve-docs")
          // Add any additional logic here after the successful publish
			...
			<div className="col-12 col-xl-8">
				<div className="container p-3 p-md-4 container-card">
					<div className="d-flex justify-detail-between mb-4">
						...
						<h3 className="fw-bold">ตั้งค่าหนังสือขอความอนุเคราะห์</h3><span className="text-danger">*</span>
					</div>
								...
								<div className="col-sm mx-2">
									<div className="form-group">
										<label className="form-label fw-bold" htmlFor="start_date">
											วันเริ่มฝึกงาน <span className="text-danger">*</span>
										</label>
										<br/>
                                    ...
                                    <div className="form-group">
										<label className="form-label fw-bold" htmlFor="end_date">
											วันสิ้นสุดฝึกงาน <span className="text-danger">*</span>
										</label>
										<div className="input-group">
										<DatePicker
											id="end_date"
									...
									<div className="form-group">
										<label className="form-label fw-bold" htmlFor="head_name">
											รูปลายเซ็นหัวหน้าภาควิชา <span className="text-danger">*</span>
										</label>
										<input
											className="form-control"
											type="file"
